...
async function migrar() {
    ...
    try {
        logger_1.logger.info('Iniciando migração do banco de dados...');
        await client.query(schema);
        logger_1.logger.info('✅ Migração concluída com sucesso!');
    }
    catch (error) {
        logger_1.logger.error('Erro na migração:', error);
        throw error;
    }
    finally {
        client.release();
